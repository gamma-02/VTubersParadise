...
public class StarterChestBlockEntityRenderer extends TileEntityRenderer<StarterChestBlockEntity> {
    ...
    public StarterChestBlockEntityRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
    ...
    public void render(StarterChestBlockEntity tileEntityIn, float partialTicks, @NotNull MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        if (block instanceof AbstractChestBlock) {
            ...
            RenderMaterial rendermaterial = getChestMaterial();
    ...
    private static RenderMaterial getChestMaterial() {
        return new RenderMaterial(Atlases.CHEST_ATLAS, new ResourceLocation("entity/chest/normal"));
    }
}
