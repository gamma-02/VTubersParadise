...
public class StartingChestFeature extends Feature<NoFeatureConfig> {
    ...
    public boolean generate(ISeedReader reader, ChunkGenerator generator, Random rand, BlockPos pos, NoFeatureConfig config) {
        ...
        Inventory.set(0, VTubersParadise.SHINE_SWORD_L1.get().getDefaultInstance());
        Inventory.set(0, VTubersParadise.SLIME_SWORD_L1.get().getDefaultInstance());
        Inventory.set(0, VTubersParadise.BECKY_BOWL_L1.get().getDefaultInstance());
        Inventory.set(0, VTubersParadise.DISDEERS_CLAWS_L1.get().getDefaultInstance());
        Inventory.set(0, VTubersParadise.NEON_BLADE_L1.get().getDefaultInstance());
        Inventory.set(0, VTubersParadise.FIRE_KATANA_L1.get().getDefaultInstance());
        Inventory.set(0, VTubersParadise.HELL_TRIDENT_L1.get().getDefaultInstance());
        Inventory.set(0, VTubersParadise.ASTRO_SCYTHE_L1.get().getDefaultInstance());
