...
public class VTubersParadise
{
    ...
    public static final RegistryObject<Item> NEON_BLADE_L1 = Items.register("neon_blade_l1", () -> new NeonBladeL1(ItemTier.NETHERITE, 0, -2.5f, new Item.Properties().isImmuneToFire().group(ItemGroup.COMBAT)));
    public static final RegistryObject<Item> NEON_BLADE_L2 = Items.register("neon_blade_l2", () -> new NeonBladeL2(ItemTier.NETHERITE, 2, -2.5f, new Item.Properties().isImmuneToFire().group(ItemGroup.COMBAT)));
    public static final RegistryObject<Item> NEON_BLADE_L3 = Items.register("neon_blade_l3", () -> new NeonBladeL3(ItemTier.NETHERITE, 4, -2.3f, new Item.Properties().isImmuneToFire().group(ItemGroup.COMBAT)));
