...
public class HellTridentEntityL2 extends AbstractArrowEntity implements IAnimatable
{
    ...
    public HellTridentEntityL2(World worldIn, LivingEntity thrower, ItemStack thrownStackIn) {
        super(VTubersParadise.HELL_TRIDENT_ENTITY_L2.get(), thrower, worldIn);
    ...
    public HellTridentEntityL2(World worldIn, double x, double y, double z) {
        super(VTubersParadise.HELL_TRIDENT_ENTITY_L2.get(), x, y, z, worldIn);
    }
