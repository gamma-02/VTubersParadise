...
public class HellTridentEntityL1 extends AbstractArrowEntity implements IAnimatable
{
    ...
    public HellTridentEntityL1(EntityType<? extends HellTridentEntityL1> type, World worldIn) {
        super(type, worldIn);
    }
