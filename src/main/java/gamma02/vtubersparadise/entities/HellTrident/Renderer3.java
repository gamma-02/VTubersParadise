...
@OnlyIn(Dist.CLIENT)
public class Renderer3 extends EntityRenderer<HellTridentEntityL3> {
    ...
    public Renderer3(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }

    public void render(HellTridentEntityL3 entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
     ...
     */
    public ResourceLocation getEntityTexture(HellTridentEntityL3 entity) {
        return TRIDENT;
    }
}
